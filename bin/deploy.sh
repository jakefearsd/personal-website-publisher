...
echo "docker exec -it -u crafter crafter-deployer /opt/crafter/bin/init-site.sh -b main -u jakefearsd -p <YOUR_PAT> jakefear https://github.com/jakefearsd/personal-site.git"
